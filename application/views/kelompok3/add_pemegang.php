            ...
            <div class="container-fluid  dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Pemegang Kendaraan</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Tambah Pemegang Kendaraan</h5>
                                <div class="card-body">
                                    <form id="form" data-parsley-validate="" novalidate="" method="post" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right">Pemegang</label>
                                            <div class="col-9 col-lg-10">
                                                <input id="pemegang" type="text" required="" placeholder="Masukkan Pemegang Kendaraan" class="form-control" name="pemegang">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputWebSite" class="col-3 col-lg-2 col-form-label text-right">Kode</label>
                                            <div class="col-9 col-lg-10">
                                                <input id="kode" type="text" required="" placeholder="Masukkan Kode" class="form-control" name="kode_pemegang">
                                            </div>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first" id="datatable_randis">
                                        ...
                                        <tbody>
                                            <?php $no = 1; ?>
                                            <?php foreach ($pemegang_kendaraan as $key => $value) { ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td> <?php echo $value->pemegang;?></td>
                                                <td><?php echo $value->kode_pemegang;?> </td>
                                                <td> <button>
                                                        <a href="<?php echo site_url("kelompok3/delete_pemegang/".$value->id); ?>" onclick="return confirm('Yakin di hapus?')" class="" style="color:#FF0000;"> 
