            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Tambah Tipe Kendaraan</h5>
                                <div class="card-body">
                                    <form id="form" data-parsley-validate="" novalidate="" method="post" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right">Tipe</label>
                                            <div class="col-9 col-lg-10">
                                                <input id="type" type="text" required="" placeholder="Masukkan Tipe Kendaraan" class="form-control" name="type">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                        <div class="card">
                            <h5 class="card-header">Daftar Tipe Kendaraan</h5>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first" id="datatable_randis">
                                        ...
                                        <tbody>
                                            <?php $no = 1; ?>
                                            <?php foreach ($tipe_kendaraan as $key => $value) { ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
